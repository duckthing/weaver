...
function ToolDrawer:new(rules)
	...
	local drawShapeBtn = IconButton(buttonRules, function() DrawShapeTool:selectTool() end, toolSpriteSheet, 5, 2)
	local rectMarqueeBtn = IconButton(buttonRules, function() RectSelectTool:selectTool() end, toolSpriteSheet, 6, 2)
	local magicMarqueeBtn = IconButton(buttonRules, function() MagicSelectTool:selectTool() end, toolSpriteSheet, 7, 2)
	local selectionTransformBtn = IconButton(buttonRules, function() SelectionTransformTool:selectTool() end, toolSpriteSheet, 8, 2)
