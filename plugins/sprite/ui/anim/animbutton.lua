...
---@class AnimTimeline.Button: BaseButton
local AnimButton = BaseButton:extend()

---@param rules Plan.Rules
---@param onClick function
---@param scale integer
function AnimButton:new(rules, onClick, scale)
	AnimButton.super.new(self, rules, onClick)
	self.scale = scale
end

function AnimButton:draw()
